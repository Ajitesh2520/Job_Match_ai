...
describe('SkillScorer', () => {
  ...
  describe('no nice-to-have skills', () => {
  ...
  describe('nice-to-have contribution', () => {
  ...
  describe('normalization', () => {
    ...
    it('deduplicates duplicate normalized nice-to-have skill entries', () => {
      const result = scorer.score(
        candidate(['go']),
        job([
    ...
    it('deduplicates duplicate normalized must-have skill entries', () => {
      const result = scorer.score(
        candidate(['typescript']),
        job([
          { skill: 'TypeScript', type: 'MUST_HAVE' },
      ...
      expect(result.details.mustHaveTotal).toBe(1);
      expect(result.details.mustHaveMatched).toBe(1);
      expect(result.score).toBe(50);
    });
  });
